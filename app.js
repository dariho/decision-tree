...
const effectSizeLabels = {
  de: {
    ...
    ranges: {
      ...
      mcnemarOr: "jamovi gibt diesen Odds Ratio nicht aus. Berechnen Sie ihn manuell als b/c oder c/b, wobei b und c die diskordanten Häufigkeiten in der 2x2-Tabelle sind.",
  ...
  en: {
    ...
    ranges: {
      ...
      mcnemarOr: "jamovi does not provide this odds ratio. Calculate it manually as b/c or c/b, where b and c are the discordant frequencies in the 2x2 table.",
  ...
  fr: {
    ...
    ranges: {
      ...
      mcnemarOr: "jamovi ne fournit pas cet odds ratio. Calculez-le manuellement comme b/c ou c/b, où b et c sont les fréquences discordantes dans le tableau 2x2.",
  ...
  es: {
    ...
    ranges: {
      ...
      mcnemarOr: "jamovi no proporciona este odds ratio. Calcúlelo manualmente como b/c o c/b, donde b y c son las frecuencias discordantes en la tabla 2x2.",
  ...
  it: {
    ...
    ranges: {
      ...
      mcnemarOr: "jamovi non fornisce questo odds ratio. Calcolalo manualmente come b/c o c/b, dove b e c sono le frequenze discordanti nella tabella 2x2.",
